...
class Faction:
    ...
    def apply_mod_settings(self, mod_settings: Optional[ModSettings] = None) -> None:
        ...
        if not mod_settings.swedishmilitaryassetspack:
            self.remove_vehicle("[SMA] RBS 70 EldE 70 Mobile SAM LN")
            self.remove_vehicle("[SMA] RBS 90 EldE 90 Mobile SAM LN")
            self.remove_vehicle("[SMA] LvS-103 Lavett 103 Rb103A Stationary SAM LN")
            self.remove_vehicle("[SMA] LvS-103 Lavett 103 Rb103B Stationary SAM LN")
            self.remove_vehicle("[SMA] LvS-103 Lavett 103 Rb103A Mobile SAM LN")
            self.remove_vehicle("[SMA] LvS-103 Lavett 103 Rb103B Mobile SAM LN")
            self.remove_vehicle("[SMA] LvS-103 StriE 103 Mobile SAM ECS")
            self.remove_vehicle("[SMA] LvS-103 PM 103 Stationary SAM STR")
            self.remove_vehicle("[SMA] LvS-103 PM 103 Mobile SAM STR")
            self.remove_vehicle("[SMA] LvS-103 Elverk 103 Mobile SAM EPP")
            self.remove_vehicle("[SMA] Lvkv 9040 SPAAG")
            self.remove_vehicle("[SMA] RBS 70 EldE 70 Stationary SAM LN")
            self.remove_vehicle("[SMA] RBS 90 EldE 90 Stationary SAM LN")
            self.remove_vehicle("[SMA] RBS 98 EldE 98 Mobile SAM LN")
            self.remove_vehicle("[SMA] UndE 23 (RBS 70/90/98) SAM STR")
            self.remove_vehicle("[SMA] Bv 410 ATV")
            self.remove_vehicle("[SMA] Strf 9040 IFV")
            self.remove_vehicle("[SMA] Strv 103 MBT")
            self.remove_vehicle("[SMA] Strv 121 MBT")
            self.remove_vehicle("[SMA] Strv 122 MBT")
            self.remove_vehicle("[SMA] Strv 2000 T140/40 MBT")
            self.remove_vehicle("[SMA] Volvo 740 Improvised fighting vehicle")
            self.remove_vehicle("[SMA] RBS 15KA LBASM")
            self.remove_vehicle("[SMA] Ag 90 Sniper team")
            self.remove_vehicle("[SMA] Ak 4 Soldier")
            self.remove_vehicle("[SMA] Ak 5 Soldier")
            self.remove_vehicle("[SMA] Ak 5 Granattillsats Soldier")
            self.remove_vehicle("[SMA] Ksp 90 Soldier")
            self.remove_vehicle("[SMA] Ksp 58 Soldier")
            self.remove_vehicle("[SMA] Pskott 86 Soldier")
            self.remove_vehicle("[SMA] RBS 57 ATGM")
            self.remove_vehicle("[SMA] RBS 58 ATGM")
            self.remove_vehicle("[SMA] Artillerisystem 08 SPG")
            self.remove_vehicle("[SMA] Grkpbv 90 SPM")
            self.remove_ship("[SMA] HSwMS Visby Corvette")
            self.remove_ship("[SMA] Strb 90 FAC")
